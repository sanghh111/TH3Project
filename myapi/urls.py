...
from . import views,views_saler ,views_customer
from rest_framework_simplejwt import views as jwt_views

urlpatterns = [
    re_path(r'^token$',view= jwt_views.TokenObtainPairView().as_view(),name='token'),
    re_path(r'^refresh$',view= jwt_views.TokenRefreshView().as_view(),name='refresh'),
    ...
    re_path(r'^shopping-carts$',view = views_customer.APIListShoppingCart.as_view(), name = 'list-shopping-cart'),
]
